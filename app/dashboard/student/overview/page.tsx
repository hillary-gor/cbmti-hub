    ...
    return (
      <div className="p-6 space-y-4 text-center">
        ...
        <p className="text-gray-500 max-w-lg mx-auto">
          Unable to load student data. This system is currently under
          maintenance to ensure you get full access to your academic details.
        </p>
        <p className="text-xl font-semibold text-blue-600 dark:text-blue-400">
          Stay tuned. Check back soon for updates.
        </p>
      </div>
    );
  }

  const { student, grades, fees, certificates, transcript, attendance } =
    overview;
    ...
    <div className="p-4 sm:p-6 lg:p-8 space-y-8">
      ...
      <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <InfoCard
          ...
          content={student.enrollment_year?.toString() ?? "N/A"}
        />
