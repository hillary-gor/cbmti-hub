...
export default function StudentShellLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex h-screen flex-col lg:flex-row bg-gray-50 dark:bg-zinc-900 relative">
        ...
        {isOpen && (
          <>
            ...
            <motion.aside
              ...
              className="fixed z-50 inset-y-0 left-0 w-64 transform bg-white dark:bg-zinc-800 border-r shadow-lg lg:hidden"
            >
      ...
      <aside className="hidden lg:block w-64 bg-white dark:bg-zinc-800 border-r shadow-lg">
