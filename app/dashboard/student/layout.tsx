...
const navSections = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Overview", href: "/dashboard/student/overview", icon: Eye },
      {
        label: "Certificates",
    ...
    return (
      <div className="flex items-center justify-center h-screen bg-gray-100 dark:bg-zinc-950 text-gray-600 dark:text-gray-300">
        <div className="flex items-center space-x-2">
          ...
          <span>Checking student access...</span>
        </div>
      </div>
    );
  }
        ...
        {isMobileSidebarOpen && (
          <>
            ...
            >
              ...
              <StudentNav pathname={pathname} isCollapsed={false} />
