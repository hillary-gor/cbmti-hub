      ...
      {loading ? (
        ...
        <div className="text-center p-10 bg-blue-50 rounded-lg shadow-md max-w-lg mx-auto border border-blue-200">
          ...
          <p className="text-blue-600 text-lg">
            It looks like you haven not created any sessions yet.
          </p>
            ...
            >
              <CardHeader>
                <CardTitle className="text-xl font-semibold text-gray-800">
                  {session.courses?.title || "Unknown Course"} (
                  {session.courses?.code || "N/A"})
                </CardTitle>
              ...
              <CardContent className="space-y-2 flex-grow">
                ...
                <div className="pt-2">
                  <Badge
                    variant={
                      session.is_attendance_active ? "default" : "secondary"
                    }
                    className={`${session.is_attendance_active ? "bg-green-500 hover:bg-green-600" : "bg-gray-300 hover:bg-gray-400"} text-white`}
                  >
