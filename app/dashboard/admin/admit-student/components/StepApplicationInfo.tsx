...
const StepApplicationInfo = () => {
  ...
  const appErrors = errors.application_info as FieldErrors<
  ...
  return (
    <div className="space-y-4">
      ...
      <div>
        ...
        <input
          {...register("application_info.intake_month")}
          className="input"
        />
        <p className="text-red-500 text-sm">
          {getErrorMessage("intake_month")}
        </p>
      </div>
      ...
      <div>
        ...
        <input
          {...register("application_info.mode_of_study")}
          className="input"
        />
        <p className="text-red-500 text-sm">
          {getErrorMessage("mode_of_study")}
        </p>
      </div>
      ...
      <div>
        ...
        <input
          {...register("application_info.study_center")}
          className="input"
        />
        <p className="text-red-500 text-sm">
          {getErrorMessage("study_center")}
        </p>
      </div>
      ...
      <div>
        ...
        <input
          {...register("application_info.payment_method")}
          className="input"
        />
        <p className="text-red-500 text-sm">
      ...
      <div>
        ...
        <input
          {...register("application_info.payment_reference")}
          className="input"
        />
        <p className="text-red-500 text-sm">
          {getErrorMessage("payment_reference")}
        </p>
      </div>
      ...
      <div className="flex items-center gap-2">
        <input
          type="checkbox"
          {...register("application_info.disability_status")}
        />
      ...
      {disability && (
        <div>
          ...
          />
          <p className="text-red-500 text-sm">
            {getErrorMessage("disability_type")}
          </p>
        </div>
      )}
    </div>
