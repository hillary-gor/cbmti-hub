...
const StepGuardianDeclaration = () => {
  ...
  const guardianErrors = errors.guardian_declaration as FieldErrors<FormData['guardian_declaration']>;
  ...
  return (
    <div className="space-y-4">
      <div>
        ...
        />
        <p className="text-red-500 text-sm">{getErrorMessage('guardian_full_name')}</p>
      </div>
      ...
      <div>
        ...
        />
        <p className="text-red-500 text-sm">{getErrorMessage('guardian_id_number')}</p>
      </div>
      ...
      <div>
        <input
          ...
          placeholder="Email"
        />
        <p className="text-red-500 text-sm">{getErrorMessage('guardian_email')}</p>
      </div>
