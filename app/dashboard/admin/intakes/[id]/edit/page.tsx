...
import {
  ...
  Settings,
  Loader2,
  Stethoscope, // Added for icon mapping
  Hospital, // Added for icon mapping
  Book, // Added for icon mapping
  GraduationCap, // Added for icon mapping
  Heart, // Added for icon mapping
  Pill, // Added for icon mapping
} from "lucide-react";
...
// Mapping for Lucide React components
...
export default function EditIntakePage() {
  ...
  const loadIntake = useCallback(async () => {
    try {
      ...
      if (intake) {
        ...
        setSubmitMessage("Intake not found");
      }
    } catch (error) {
  ...
  }, [intakeId, setFormData, setSubmitStatus, setSubmitMessage, setLoading]);
  ...
  const handleInputChange = <K extends keyof IntakeFormData>(
    ...
    setFormData((prev) => {
      ...
      if (field === "year" || field === "month") {
        const year = updated.year as string | undefined;
        const month = updated.month as string | undefined;

        if (year && month) {
          updated.label = `${month}-${year}`;
        }
      }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const result = await updateIntake(intakeId, formData as IntakeFormData);
  ...
  // Render icon based on icon_name
      ...
      <header className="relative z-50 bg-gradient-to-r from-blue-600/10 to-cyan-400/10 backdrop-blur-md border-b border-blue-200/30">
        <div className="container mx-auto px-4 py-4">
          <nav className="flex items-center justify-between">
            <Link href="/intakes" className="flex items-center space-x-3">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center space-y-6">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Modify the intake details and settings for this course enrollment.
            </p>
          </div>
        </div>
      </section>
              ...
              <div className="lg:col-span-2 space-y-8">
                ...
                <Card className="bg-white/80 backdrop-blur-xl border-2 border-blue-100/50 shadow-xl rounded-3xl">
                  <CardHeader>
                    ...
                    <CardDescription>
                      Update the fundamental intake details
                    </CardDescription>
                  </CardHeader>
                ...
                <Card className="bg-white/80 backdrop-blur-xl border-2 border-green-100/50 shadow-xl rounded-3xl">
                  <CardHeader>
                    ...
                    <CardDescription>
                      Update the intake timeline and course schedule
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-6">
                    <div className="grid md:grid-cols-2 gap-4">
                ...
                <Card className="bg-white/80 backdrop-blur-xl border-2 border-purple-100/50 shadow-xl rounded-3xl">
                  <CardHeader>
                    ...
                    <CardDescription>
                      Update location and enrollment limits
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-6">
                    <div className="grid md:grid-cols-3 gap-4">
              ...
              <div className="space-y-6">
                ...
                <Card className="bg-gradient-to-br from-blue-50 to-cyan-50 border-2 border-blue-200 shadow-xl rounded-3xl sticky top-24">
                  <CardHeader>
                    ...
                    <CardDescription>
                      How this intake will appear to students
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex items-center justify-between text-sm">
                        ...
                        <span className="font-medium">
                          {formData.enrolled_students}/{formData.total_spots}
                        </span>
                      </div>
                      <div className="flex items-center justify-between text-sm">
                      ...
                      <div className="w-full bg-gray-200 rounded-full h-2">
                        <div
                          ...
                          style={{
                            ...
                            background: `linear-gradient(135deg, ${
                              formData.color_gradient_from || "#A0A0A0"
                            }, ${formData.color_gradient_to || "#D0D0D0"})`, // Fallback for gradient
                          }}
                        ></div>
                      </div>
                    </div>

                    {/* Ensure color preview also handles null/undefined */}
