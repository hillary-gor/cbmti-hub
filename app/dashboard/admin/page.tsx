...
const tiles = [
  ...
  { title: "📚 Manage Intakes", href: "/dashboard/admin/intakes" }, // Uncommented
  { title: "📝 Manage Applications", href: "/dashboard/admin/applications" }, // Added Applications link
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600 dark:text-gray-400">
          Welcome to the CBMTI Admin Panel. Use the tools below to manage core
          operations.
        </p>
      </div>
      ...
      <section>
        ...
        <p className="text-gray-600 dark:text-gray-400 mb-4 text-sm">
          Coming soon: live stats on students, intakes, pending approvals, and
          more.
        </p>
